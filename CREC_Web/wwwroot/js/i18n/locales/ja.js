...
registerTranslations('ja', {
    ...
    'projects-select': '選択',
    'projects-switch': 'このプロジェクトに切り替える',
    'projects-refresh': '一覧を更新',
    'projects-reload': '新しいプロジェクトを表示',
    'projects-admin-token': '管理者トークン',
    'projects-login': '管理者として認証',
    'projects-auth-help': 'サーバー起動時に表示された管理者トークンを入力してください。',
    ...
    'projects-unauthorized': '管理者の認証が必要です。トークンを確認して再度認証してください。',
