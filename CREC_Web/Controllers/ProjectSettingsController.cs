    ...
    public IActionResult UpdateProjectSettings([FromBody] UpdateProjectSettingsRequest request)
    {
        ...
        try
        {
            lock (_fileLock)
            {
                ...
                var lines = System.IO.File.ReadAllLines(crecFilePath, System.Text.Encoding.UTF8);
                ...
                System.IO.File.WriteAllLines(crecFilePath, updatedLines, System.Text.Encoding.UTF8);
