...
public class ProjectSettingsService
{
    ...
    [
        "ProjectDataPath", "CrecFilePath", "ProjectName", "CollectionNameLabel", "UUIDLabel",
        "ManagementCodeLabel", "CategoryLabel", "FirstTagLabel", "SecondTagLabel", "ThirdTagLabel"
    ];
    ...
    {
        // 相対パスは従来どおり作業ディレクトリ基準で扱うため、この段階では書き換えない。
